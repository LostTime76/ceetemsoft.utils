...
unsafe public static class Utf8Utils
{
    ...
    /// encoded from the managed strings within a span. The array is null terminated.
	/// </summary>
	/// <param name="span">
	...
	/// <summary>
    /// Gets the number of null terminated utf8 strings within a null terminated array
    /// </summary>
    /// <param name="array">
    /// The array containing the null terminated utf8 strings to count
    /// </param>
    /// <returns>
    /// The number of strings within the array if successful, otheriwise -1 if
	...
	/// <summary>
    /// Creates a managed string array produced by decoding all of the null terminated utf8 strings
    /// within a null terminated native array
    /// </summary>
    /// <param name="array">
    /// The null terminated native array containing the strings to decode
    /// </param>
    /// <returns>
    /// The managed string array. If <paramref name="array"/> is null, null is returned
    /// </returns>
	public static string[]? GetArray(byte** array)
	{
		return GetArray(array, GetLength(array));
	}
